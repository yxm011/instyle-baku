    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-serif mb-4">Qeydiyyat</h2>
          <div className="h-px w-24 bg-luxury-gold mx-auto mb-4"></div>
          <p className="text-gray-600 font-light">Yeni hesab yaradın</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? 'Gözləyin...' : 'QEYDİYYATDAN KEÇ'}
          </button>
        </form>
        ...
        <div className="mt-6">
          ...
          >
            ...
            GOOGLE İLƏ QEYDİYYAT
          </button>
        </div>

        <p className="mt-8 text-center text-gray-600 font-light">
          Artıq hesabınız var?{' '}
          <Link to="/login" className="text-luxury-gold luxury-hover font-normal">
            Daxil olun
          </Link>
        </p>
      </div>
